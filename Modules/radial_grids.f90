...
subroutine series(f,r,r2,b)
  ...
  real(DP):: dr21,dr31,dr32,dr41,dr42,dr43,df21,df32,df43, &
       ddf42,ddf31 
  real(DP):: f(4), &  ! the function to be expanded
             r(4), &  ! the points the function is been evaluated 
             r2(4)    ! the points the function is been evaluated squared
  real(DP),intent(out) :: b(0:3)
